...
import { ArrowLeft, Download, Save, Palette, Type, Image as ImageIcon, Layout, Layers } from 'lucide-react';
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={handleSave}
              className="flex items-center gap-2 px-5 py-2.5 bg-gray-900 text-white rounded-full font-semibold text-sm hover:bg-gray-800 transition"
            >
              <Save size={16} />
              Save Design
            </button>
